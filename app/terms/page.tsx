...
import { LEGAL_TERMS_CONTENT } from "@/lib/legal-content";

export const metadata: Metadata = {
	title: "Regulamin | Hopety",
	description: "Regulamin korzystania z listy oczekujacych aplikacji Hopety.",
};
			...
			<div className="mx-auto w-full max-w-3xl">
				...
				<article className="p-2 text-text md:p-4">
					...
					<div className="mt-6 space-y-4 text-text/80 leading-relaxed">
						<LegalMarkdown source={LEGAL_TERMS_CONTENT} />
					</div>
				</article>
			</div>
		</main>
