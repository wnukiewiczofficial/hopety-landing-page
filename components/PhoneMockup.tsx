    ...
    <div className="flex flex-col items-center">
      <div className={rotate ? 'rotate-3' : ''}>
        <div className="relative bg-[#1a0a2e] rounded-[2.8rem] p-[10px] shadow-2xl w-[200px] md:w-[220px]">
          <div className="absolute top-[14px] left-1/2 -translate-x-1/2 w-[72px] h-[20px] bg-[#1a0a2e] rounded-full z-10 flex items-center justify-center gap-1.5">
            <div className="w-2.5 h-2.5 rounded-full bg-[#0f0620]" />
          </div>
          <div
            className="relative overflow-hidden rounded-[2.3rem] bg-card"
      ...
      {label && (
        <p className="text-sm text-center mt-4 text-text/60 font-medium">{label}</p>
      )}
    </div>
  );
}
